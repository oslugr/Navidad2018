...
function create_image($user){
	...
	if (!file_exists($file)) {	
			...
			$im = imagecreatefromjpeg("imagen2_calendario.jpg");
			...
			$color['blue'] = imagecolorallocate($im, 00, 255, 255);	 
...
<div class="divimagen">
<p style="font-size: 20px;    color: blue;    width: 80%;"><b> 1. Esta es la imagen elegida</b></p>
...
<p style="font-size:  20px; color: blue; width: 40%;display:  inline-table;"><b> 2. Introduce el texto</b></p>
...
<p style="font-size:  20px; color: blue; width: 100%;display:  inline-table;"><b> 3. Actualiza tu imagen</b></p>
	<input name="submit" type="submit" class="btn btn-primary" value="Actualizar Imagen" style="margin: 3%;" />
<p style="font-size:  20px; color: blue; width: 100%;display:  inline-table;"><b> 4. Descarga la felicitación</b></p>
...
<p style="font-size:  0px; color: blue; width: 100%;display:  inline-table;"> 4. Descarga la felicitación</p>
